...
<html xmlns="http://www.w3.org/1999/xhtml">
    <!--HEAD-->
    <head>
        <title>Dress_Haat | Registration & Login</title>
    ...
    <body>
        ...
        <h2>New User Registration</h2>
            ...
            <form action="insert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);"
            enctype="multipart/form-data" name="form2" id="form2">
                ...
                <tr>
                    ...
                    <span class="textfieldRequiredMsg" style="color:red">*</span></span></td>
                </tr>
                <tr>
                    ...
                    <span class="textareaRequiredMsg" style="color:red">*</span></span></td>
                </tr>
                <tr>
                    <td height="37"><div align="left">District:</div></td>
                    <td><label>
                ...
                <tr>
                    ...
                    <label>
                        +880 <input type="text" name="txtMobile" id="txtMobile" />
                    </label>
                    <span class="textfieldRequiredMsg" style="color:red">*</span></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><!--<span id="sprytextfield7">-->
                    <label>
                        <input type="text" name="cardn" id="txtPassword" />
                    </label>
                    <span class="textfieldRequiredMsg" style="color:red">*</span><!--</span>--></td>
                </tr>
                    <tr>
                    <td height="30">Transaction PIN:</td>
                    <td><!--<span id="sprytextfield7">-->
                    <label>
                        <input type="text" name="tn" id="txtPassword" />
                    </label>
                    <span class="textfieldRequiredMsg" style="color:red">*</span><!--</span>--></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td><label>
                        <input class="product-btn" type="submit" name="button2" id="button2" value="Register" />
                    </label></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
        ...
        <div id="right-col">
            ...
            <table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-left:15px">
                <tr>
                ...
                <tr>
                    <td><label>
                    <div align="center">
                        <input class="product-btn" type="submit" name="button" id="button" value="Login">
                    </div>
                    </label></td>
                </tr>
                <tr>
