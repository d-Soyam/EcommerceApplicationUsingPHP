...
if (!function_exists("GetSQLValueString")) {
    ...
    $query_Recordset1 = sprintf("SELECT ItemId, ItemName, Description, Color, Fabric, V_A, Quantity, Image, Price, Discount, Total FROM item_master WHERE CategoryId = %s", GetSQLValueString($colname_Recordset1, "int"));
    $Recordset1 = mysql_query($query_Recordset1, $shop) or die(mysql_error());
    $row_Recordset1 = mysql_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysql_num_rows($Recordset1);

    mysql_select_db($database_shop, $shop);
    $query_Recordset2 = "SELECT ItemId, ItemName, Description, Color, Fabric, V_A, Quantity, Image, Price, Discount, Total FROM item_master";
        ...
        <h2>Products</h2>
            ...
            <?php
                ...
                do { ?>
                    ...
                    <a class="product-btn" href="InsertCart.php?ItemId=<?php echo $row_Recordset1['ItemId']; ?>"><span>BDT= <?php echo $row_Recordset1['Total']; ?>/-</span>ADD TO CART</a>    
                    </div>
                <?php }
                while ($row_Recordset1 = mysql_fetch_assoc($Recordset1));
		          ...
		          do { ?>
                    ...
                    <a class="product-btn" href="InsertCart.php?ItemId=<?php echo $row_Recordset2['ItemId']; ?>"><span>BDT= <?php echo $row_Recordset2['Total']; ?>/-</span>ADD TO CART</a>
                    </div>
                <?php }
